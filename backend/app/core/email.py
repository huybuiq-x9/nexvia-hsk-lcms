...
def build_password_reset_email(reset_url: str, user_name: str) -> tuple[str, str]:
    subject = "NEXEDU LCMS — Đặt lại mật khẩu"
    text = (
        f"Xin chào {user_name},\n\n"
        f"Bạn đã yêu cầu đặt lại mật khẩu cho tài khoản NEXEDU LCMS.\n"
    ...
    <body>
      <div class="container">
        <div class="logo">NEXEDU LCMS</div>
        ...
        <div class="footer">
          NEXEDU LCMS — Hệ thống Quản lý Nội dung Học tập<br/>
